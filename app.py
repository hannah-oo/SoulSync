...
@app.route('/save_rec_hashtags', methods=['POST'])
def save_rec_hashtags():
    global selected_hashtags
    data = request.get_json()
    selected_hashtags = data.get('hashtags', [])
    return jsonify({"message": "Hashtags saved successfully", "hashtags": selected_hashtags})
